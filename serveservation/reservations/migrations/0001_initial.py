...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reservations_reservation', (
            ...
            ('reserved_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        # Adding model 'Server'
        db.create_table('reservations_server', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reservation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reservations.Reservation'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('operatingSystem', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ...
        db.send_create_signal('reservations', ['Server'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('reservations_server')
    ...
    models = {
        ...
        'reservations.reservation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reserved_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
        ...
        'reservations.server': {
            ...
            'operatingSystem': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
