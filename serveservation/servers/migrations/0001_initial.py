...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('servers_server', (
            ...
            ('operating_system', self.gf('django.db.models.fields.CharField')(default='', max_length=150)),
            ('ip_address', self.gf('django.db.models.fields.IPAddressField')(default='0.0.0.0', max_length=15)),
            ('cpu', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('memory', self.gf('django.db.models.fields.IntegerField')()),
            ('operational', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.create_table('servers_reservation', (
            ('reservation_title', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ...
            ('start_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 6, 27, 0, 0), null=True)),
            ('end_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 6, 27, 0, 0), null=True)),
            ('server', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['servers.Server'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('servers', ['Reservation'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('servers_reservation')
    ...
    models = {
        ...
        'servers.reservation': {
            ...
            'reservation_title': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
