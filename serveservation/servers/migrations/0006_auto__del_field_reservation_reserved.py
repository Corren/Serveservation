...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Reservation.reserved'
        db.delete_column('servers_reservation', 'reserved')


    def backwards(self, orm):
        # Adding field 'Reservation.reserved'
        db.add_column('servers_reservation', 'reserved',
