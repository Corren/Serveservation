...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ExpiredReservation'
        db.delete_table('servers_expiredreservation')

    def backwards(self, orm):
        # Adding model 'ExpiredReservation'
        db.create_table('servers_expiredreservation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('servers', ['ExpiredReservation'])
    ...
    models = {
        ...
        'servers.reservation': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 28, 0, 0)', 'null': 'True'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 28, 0, 0)', 'null': 'True'})
        },
        'servers.server': {
